...
class TestGradients(unittest.TestCase):
    def setUp(self):
        ...
        baseyaml = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__))))), "examples", "wisdem", "02_reference_turbines", "nrel5mw.yaml")
